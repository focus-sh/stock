...
def stat_all(tmp_datetime):
    ...
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_report_data", False, "`quarter`,`code`")
    ...
    data = data.drop_duplicates(subset="code", keep="last")
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_profit_data", False, "`quarter`,`code`")
    ...
    data = data.drop_duplicates(subset="code", keep="last")
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_operation_data", False, "`quarter`,`code`")
    ...
    data = data.drop_duplicates(subset="code", keep="last")
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_growth_data", False, "`quarter`,`code`")
    ...
    data = data.drop_duplicates(subset="code", keep="last")
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_debtpaying_data", False, "`quarter`,`code`")
    ...
    data = data.drop_duplicates(subset="code", keep="last")
    # 插入数据库。
    lib.mysql.insert_db(data, "ts_cashflow_data", False, "`quarter`,`code`")
